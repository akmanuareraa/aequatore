    ...
    <>
      <div className="relative flex flex-col items-center w-full mt-20 space-y-8">
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-row items-center justify-between w-full">
              <div className="flex flex-row items-center justify-between">
                <div className="flex flex-row items-center">
                  {/* logo block */}
                  <div className="flex flex-row items-center mr-16 space-x-6">
                    <img
                      src={logoSymbolWhite}
                      alt="logo"
                      className="w-16 h-16"
          ...
          {/* who we are
          <div className="z-10 flex flex-col items-center justify-center p-8 mt-40 mb-28 space-x-36">
            left container
            ...
            right container
            <div className="flex flex-col justify-center items-center space-y-8 w-[450px]">
