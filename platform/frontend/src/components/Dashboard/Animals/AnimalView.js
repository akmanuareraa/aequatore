...
function AnimalView(props) {
  ...
  const submitForm = async () => {
    ...
    if (validateForm() === false) {
      ...
      try {
        ...
        tempAnimalsArray = tempAnimalsArray.filter(
          (item) => item.id !== tempAnimalData.id
        );
  ...
  useEffect(() => {
    if (Object.keys(appData.animalInView).length > 0) {
      setFormData(appData.animalInView);
    }
  }, [appData.animalInView]);
    ...
    <div className="w-full h-full px-4 overflow-x-hidden overflow-y-scroll bg-black">
      <div>
        ...
        <div className="flex flex-row items-center justify-between">
          {/* title */}
          <p className="text-2xl font-bold text-white">Animal View</p>
            ...
            <div className="form-control w-fit">
              ...
              <div className=" dropdown">
                <button
                  ...
                  disabled:text-white disabled:bg-white/10 disabled:cursor-not-allowed
